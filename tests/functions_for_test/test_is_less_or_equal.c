...
START_TEST(is_less_or_equal_1)  // сравнение нулей с разным знаком
{
...
START_TEST(
    is_less_or_equal_2)  // сравнение децималов с разным знаком (второй меньше)
{
...
START_TEST(is_less_or_equal_3)  // сравнение нулей с разным знаком и экспонентой
{
...
START_TEST(is_less_or_equal_4)  // второй децимал больше
{
  s21_decimal val1 = {0, 0, 0, 0};
...
START_TEST(is_less_or_equal_5)  // второй децимал меньше
{
...
START_TEST(
    is_less_or_equal_6)  // сравнение децималов с разным знаком (второй больше)
{
...
START_TEST(is_less_or_equal_7)  // сравнение минимального значения
{
...
START_TEST(is_less_or_equal_8)  // cравнение максимального значения
{
...
START_TEST(is_less_or_equal_9)  // сравнение отрицательных децималов
{
...
START_TEST(
    is_less_or_equal_10)  // сравнение отрицательных децималов (второй больше)
{
...
START_TEST(
    is_less_or_equal_11)  // сравнение отрицательных децималов (второй меньше)
{
  s21_decimal val1 = {0, 0, MAX_UINT, MINUS};
...
START_TEST(is_less_or_equal_12)  // второй децимал больше, разные экспоненты
{
...
START_TEST(is_less_or_equal_13)  // второй децимал меньше, разные экспоненты
{
  s21_decimal val1 = {100, 0, 0, EXPONENT_27};  // 1000
  s21_decimal val2 = {1, 0, 0, MAX_EXPONENT};
  int actual = s21_is_less_or_equal(val1, val2);
  int expected = 0;
  ck_assert_int_eq(actual, expected);
...
Suite *suite_s21_is_less_or_equal(void) {
  Suite *s1 = suite_create("s21_is_less_or_equal");
